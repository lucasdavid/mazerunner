...
try:
    if platform.system() =='cli':
        libsimx = ct.CDLL(os.path.join(base_directory, "remoteApi.dll"))
    elif platform.system() =='Windows':
        libsimx = ct.CDLL(os.path.join(base_directory, "remoteApi.dll"))
    elif platform.system() == 'Darwin':
        libsimx = ct.CDLL(os.path.join(base_directory, "remoteApi.dylib"))
    else:
        libsimx = ct.CDLL(os.path.join(base_directory, "remoteApi.so"))
except:
    print ('----------------------------------------------------')
